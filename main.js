...
movies.push({ title: "Revolver", director: "Guy Richie", genre: "Thriller", year: "2005", actors: ["Jason Statham", "Ray Liotta", "André Benjamin"]})
...
movie_titles = movies.sort(function(film)) {
  return movies.title
}
